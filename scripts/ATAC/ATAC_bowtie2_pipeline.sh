...
# Align and filter file by quality then sort by NAME. We do not save the output of bowtie2 so we output to sam to avoid 
# compression to BAM.
# TODO pipe bowtie into samtools view
